  ...
  return (
    <footer className="bg-gradient-to-b from-black via-[#0a0f1c] to-[#0f0f0f] text-white pt-16 pb-8 border-t border-[#1e90ff30]">
      ...
      >
        ...
        {/* 🌐 Follow Me */}
        <div className="order-3 sm:col-span-2 md:col-span-1 rounded-xl bg-white/1 backdrop-blur-sm p-4">
          <h3 className="text-lg font-semibold mb-4 text-orange-400">
            Follow Me
          </h3>
          <div className="flex gap-5 text-2xl">
            {[
              ...
              [FaInstagram, "#E1306C", "https://instagram.com/asyncnikhil"],
        ...
        {/* ❓ FAQs */}
        <div className="order-4 sm:col-span-2 md:col-span-1 rounded-xl bg-white/1 backdrop-blur-sm p-4">
          <h3 className="text-lg font-semibold mb-4 text-orange-400">
            FAQs
          </h3>
      ...
      <div className="text-center mt-12 pt-8 border-t border-[#1e90ff30]">
        <p className="text-gray-400 text-xs sm:text-sm">
          © {new Date().getFullYear()} Nikhil Prajapati. Built with ❤️ using React & Tailwind CSS.
        </p>
      </div>
    </footer>
  );
